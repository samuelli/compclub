...
dojo.ready(function(){
  ...
  if(textareas && textareas.length){
    ...
    textareas.instantiate(dijit.Editor, {
          styleSheets: "/assets/css/bootstrap.css;/assets/css/main.css;/assets/css/news.css",
       plugins:["collapsibletoolbar",
       ...
       "autourllink", {name:'dijit._editor.plugins.EnterKeyHandling', blockNodeForEnter:'P'}]
              });
            }
          });